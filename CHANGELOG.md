...
- Azure VMware Solution (AVS) example component (`avs-rs`) demonstrating listing private clouds via Azure SDK for Rust ([#TBD](https://github.com/microsoft/wassette/pull/TBD))
