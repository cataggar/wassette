...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:fetch-reqwest:fetch:encoded world"
)]
#[doc(hidden)]
...
j\x01s\x01s\x01@\x01\x03urls\0\0\x04\0\x05fetch\x01\x01\x04\0\x1ecomponent:fetch\
-reqwest/fetch\x04\0\x0b\x0b\x01\0\x05fetch\x03\0\0\0G\x09producers\x01\x0cprocessed-\
